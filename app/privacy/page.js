export const metadata = { title: 'Privacy Policy | Jake Rosenbloom – United Mortgage Corp.' };

export default function PrivacyPage() {
  return (
    <main style={{ maxWidth: 760, margin: '60px auto', padding: '0 22px 80px' }}>
      <h1 style={{ fontFamily: 'var(--font-jakarta, sans-serif)', color: 'var(--navy)' }}>Privacy Policy</h1>
